# 한국 아파트 공간배치 데이터셋 {#sec:floorplan}

## 목적

한국 아파트 단위세대의 공간배치에 대한 데이터셋을 구축한다.
...
현재는 그 중에서도 특히 전자적으로 저장 및 공유되어 컴퓨터를 이용한 분석에 활용될 수 있는 것을 지칭한다.

[@sec:ml]에서 살펴본 바와 같이 한국 아파트 연구에 심층 신경망 분석을 적용하기 위해서는
한국 아파트를 잘 대표할 수 있는 데이터가 필수적이다.

단위세대 수준에서 한국 아파트의 진화과정을 분석할 수 있도록 한다.
...
단위세대 영역 및 LDK, 침실, 현관, 발코니, 화장실 등 실내 공간 배치와
시기, 지역, 면적 등 연관 정보를
